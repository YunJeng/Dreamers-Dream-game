...
class GameOver(LoadScreen):
    ...
    def __init__(self):
        ...
        self.background = setup.GFX['gameover_background']
    ...
    def update(self, surface, keys, current_time):
        ...
        if (self.current_time - self.start_time) < 10000:
            ...
            self.sound_manager.stop_music()  # 顯式停止 Game Over 音樂
            self.done = True

class Win(LoadScreen):
    """Loading Screen with Win"""
    def __init__(self):
        super(Win, self).__init__()
        self.background = setup.GFX['win_background']
        self.background = pg.transform.scale(self.background, (c.SCREEN_WIDTH, c.SCREEN_HEIGHT))
    ...
    def update(self, surface, keys, current_time):
        try:
            ...
            if (self.current_time - self.start_time) < 10000:
                ...
                self.sound_manager.stop_music()  # 顯式停止 Win 音樂
                self.done = True
        except Exception as e:
            print("Error in Win screen update:", e)
            raise
