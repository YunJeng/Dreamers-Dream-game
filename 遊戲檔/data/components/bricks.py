...
class Brick(pg.sprite.Sprite):
    ...
    def __init__(self, x, y, contents=None, powerup_group=None, name='brick',season=None):
 ...
 #winter = 1 , spring = 2 , summer = 3 , autumn = 4
    def setup_frames(self):
        if self.season == 1:
            self.frames.append(self.get_image(32, 64, 16, 16)) #bricks
            self.frames.append(self.get_image(64, 64, 16, 16)) #coin box been hit
        elif self.season == 2:
            self.frames.append(self.get_image(208, 0, 16, 16)) #bricks
            self.frames.append(self.get_image(432, 0, 16, 16)) #coin box been hit
        elif self.season == 3:
            self.frames.append(self.get_image(32, 96, 16, 16)) #bricks
            self.frames.append(self.get_image(64, 96, 16, 16)) #coin box been hit
        elif self.season == 4:
            self.frames.append(self.get_image(288, 0, 16, 16)) #bricks
            self.frames.append(self.get_image(432, 0, 16, 16)) #coin box been hit
