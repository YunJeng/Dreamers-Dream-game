...
#MARIO
        self.create_label(self.mario_label, 'DREAMER', 65, 30)
    ...
    def create_load_screen_labels(self):
        ...
        '''if self.season == 2:
            self.create_label(number_label, 'Spring', 430, 200)
        if self.season == 3:
            self.create_label(number_label, 'Summer', 430, 200)
        if self.season == 4:
            self.create_label(number_label, 'Autumn', 430, 200)
        if self.season == 1:
            self.create_label(number_label, 'Winter', 430, 200)'''
    ...
    def create_mario_image(self):
        ...
        original_image = pg.Surface((200, 256)).convert()
        original_image.blit(self.sprite_sheet, (0, 0), (13, 0, 200, 256))
        original_image.set_colorkey((92, 148, 252))
        # 縮小到 0.23 倍
        scaled_width = int(200 * 0.23)
        scaled_height = int(256 * 0.23)
        self.mario_image = pg.transform.scale(original_image, (scaled_width, scaled_height))
    ...
    '''def create_win_label(self):
        """Create the label for the WIN screen"""
        win_label = []

        self.create_label(win_label, 'YOU WIN', 290, 310)
    ...
    def create_main_menu_labels(self):
        ...
        self.create_label(player_one_game, '1 PLAYER GAME', 127, 500)
        self.create_label(player_two_game, '2 PLAYER GAME', 127, 545)
        self.create_label(top, 'TOP - ', 143, 455)
        self.create_label(top_score, '000000', 253, 455)
