...
ORIGINAL_CAPTION = "Dreamer's dream"
...
EN_SIZE_MULTIPLIER = 0.45
SIZE_MULTIPLIER = 0.23
SCALE_MULTIPLIER = 1.2
BRICK_SIZE_MULTIPLIER = 2.69
BACKGROUND_MULTIPLER = 2.679
GROUND_HEIGHT = SCREEN_HEIGHT - 85

#MARIO FORCES
#WALK_ACCEL = .15 #取消按越久走越快的機制
FIXED_SPEED = 5
RUN_ACCEL = 20
#SMALL_TURNAROUND = .35 #取消加速度
...
CASTLE_ENTRY_X = 8700 #城堡入口x座標
END_OF_LEVEL_FALL = 'end of level fall' #可留可不留，先留
...
STAR = 'star' # 無敵星星
FIREFLOWER = 'fireflower' # 火焰花
LIFE_MUSHROOM = '1up_mushroom' # 加命菇
